...
-- Dumping structure for procedure facturacion_plasencia.actualizar_capa
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_factura_venta
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_marca
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_nombre
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_pendiente_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_pendiente_empaque_sampler
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_pendiente_saldo_factura
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_pendiente_sampler
DELIMITER //
CREATE PROCEDURE `actualizar_pendiente_sampler`(IN `marca` INT, IN `nombre` INT, IN `vitola` INT, IN `capa` INT, IN `tipo_empaque` INT, IN `item` INT)
BEGIN
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_tipo
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.actualizar_vitola
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.borrar_pendiente_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_capa_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_capa_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_fechas_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_fecha_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_hons_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_hons_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_item_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_item_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_marca_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_marca_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_nombre_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_nombre_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_ordenes_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_ordenes_pendiente
DELIMITER //
...
pendiente.presentacion = pa_cinco
...
-- Dumping structure for procedure facturacion_plasencia.buscar_pendiente_excel
DELIMITER //
...
((pendiente.mes)like CONCAT("%",pa_mes, "%"))
...
DELIMITER //
CREATE PROCEDURE `buscar_pendiente_factura`(IN `pa_factura` VARCHAR(10), IN `fechade` VARCHAR(50), IN `pa_item` VARCHAR(50), IN `pa_orden` VARCHAR(50), IN `pa_hon` VARCHAR(50))
BEGIN
...
-- Dumping structure for procedure facturacion_plasencia.buscar_tipo_empaque_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_tipo_empaque_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_vitola_empaque
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.buscar_vitola_pendiente
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.datos_pendiente_programar
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.eliminar_detalle_factura
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.insertar_detallePro_temporalSinExistencia
DELIMITER //
...
DELIMITER //
CREATE PROCEDURE `insertar_detalle_factura`(IN `pa_id_pendiente` BIGINT, IN `pa_cantidad_cajas` INT, IN `pa_peso_bruto` INT, IN `pa_peso_neto` INT, IN `pa_cantidad_puros` INT, IN `pa_unidad` INT, IN `pa_observaciones` TEXT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `insertar_pendiente`(IN `fecha` DATE)
BEGIN
SET lc_time_names = 'es_ES';
insert into pendiente(
	`categoria`,
...
-- Dumping structure for procedure facturacion_plasencia.mostrar_detallesprovicional_exportar
DELIMITER //
...
DELIMITER //
CREATE PROCEDURE `mostrar_detalle_factura`(IN `pa_tipo_factura` VARCHAR(10))
BEGIN
SELECT `id_detalle`,
	`id_venta`,
	`id_pendiente`,
...
-- Dumping structure for procedure facturacion_plasencia.mostrar_detalle_factura_export
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.reporte_capas
DELIMITER //
...
DELIMITER //
CREATE PROCEDURE `reporte_facura_pendiente`(IN `fecha` DATE, IN `marca` VARCHAR(200), IN `nombre` VARCHAR(50), IN `capa` VARCHAR(50), IN `factura` VARCHAR(50))
BEGIN
 SELECT
...
-- Dumping structure for procedure facturacion_plasencia.reporte_marcas
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.reporte_nombres
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_cant_cajas
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_categoria_id
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_datos_productos
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_detalles_editar_capa
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_detalles_editar_marca
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_detalles_editar_nombre
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_detalles_editar_tipo
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_detalles_editar_vitola
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_detalles_historial_factura
DELIMITER //
CREATE PROCEDURE `traer_detalles_historial_factura`(IN `pa_id_factura` INT)
BEGIN
   SELECT `id_detalle`,
	`id_venta`,
	`id_pendiente`,
...
-- Dumping structure for procedure facturacion_plasencia.traer_detalles_productos_actualizar
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_factura_datos
DELIMITER //
...
-- Dumping structure for procedure facturacion_plasencia.traer_ventas_historial
DELIMITER //
