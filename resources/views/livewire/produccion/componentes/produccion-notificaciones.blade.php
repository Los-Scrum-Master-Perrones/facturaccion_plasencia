...
<div wire:ignore class="modal fade" id="modal_agregar_marca2" data-backdrop="static" data-keyboard="false"
    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-striped" id="catalgo_pendiente2">
                    <thead>
            ...
            <div class="modal-footer">
                <button data-bs-target="#empleados_parejas" data-bs-toggle="modal" class="btn btn-primary">
                    <span>Parejas</span>
                </button>
...
<div class="modal fade" id="empleados_parejas" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
    tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalToggleLabel">Parejas en Produccion</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <table class="table table-dark" id="tabla_empleados">
                                <thead>
                                    <tr>
                                        <th>N#</th>
                                        <th>Modulo</th>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" data-bs-target="#modal_agregar_marca2"
...
@push('scripts')
    <script>
        ...
        function cambiarOrden(params, id_pendiente) {
            ...
            var h3 = `<h5>
                        <strong>
                            (${datos.codigo_producto}) ${datos.marca} ${datos.nombre} ${datos.vitola} ${datos.capa}
                        </strong>
                    </h5>`;
        ...
        function cambiarOrdenDiferente(id_orden, params) {
            var empleados = JSON.parse(params);
            ...
            if (rowCount <= 1) {} else {
                for (var x = rowCount - 1; x > 0; x--) {
                    document.getElementById("bodyTabla2").innerHTML = "";
            ...
            empleados.forEach(element => {
                ...
                tabla_nueva = `<tr>
                                    <td>
                                        <div class="form-check">
                                            <input onclick="seleccionar_pareja('flexCheckDefault${conteo}')" class="form-check-input" type="checkbox" value="${element.id}" id="flexCheckDefault${conteo}">
                                            <label class="form-check-label" for="flexCheckDefault${conteo}">
                                                ${conteo}
                                            </label>
                                        </div>
                                    </td>
                ...
                document.getElementById("bodyTabla2").innerHTML += tabla_nueva.toString();
            });


            id_orden_cambiar = id_orden;
            id_parejas = [];
        }
        ...
        function agregar_pendiente2(id, id_pendiente) {
            ...
            if (id_parejas.length > 0) {
                ...
                if (id_pendiente === 0) {
                    @this.agregar_detalle(id_orden_cambiar, id);
                } else {
                    @this.agregar_detalle(id_pendiente, id);
                }
            }
        ...
        function seleccionar_pareja(nombre_check) {

            if ($('#'+nombre_check).is(':checked')) {
                id_parejas.push($('#'+nombre_check).val());
            } else {
                const index = id_parejas.indexOf($('#'+nombre_check).val());
                if (index !== -1) {
                    id_parejas.splice(index, 1);
                }
            }
