...
class Static_Vars_PendienteEmpaque{
   ...
   public static $e_cat5 = "";
   public static $e_cat6 = "";
   public static $e_cat7 = "";
   ...
   public static function gete_cat1s() {
    ...
    // metodo get y set
    public static function Sete_cat5s($e_cat5) {
        self::$e_cat5 = $e_cat5;
    }

    public static function gete_cat5s() {
        return self::$e_cat5;
    }
    // metodo get y set
    public static function Sete_cat6s($e_cat6) {
        self::$e_cat6 = $e_cat6;
    }

    public static function gete_cat6s() {
        return self::$e_cat6;
    }

     // metodo get y set
     public static function Sete_cat7s($e_cat7) {
        self::$e_cat7 = $e_cat7;
     }

     public static function gete_cat7s() {
         return self::$e_cat7;
      }
