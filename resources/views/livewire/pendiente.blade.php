            ...
            <div class="row">
                ...
                <div class="col">
                    <input type="text" class="form-input " placeholder="Buscar Marca" wire:model="marca"
                        style="width:100%;height:34px;" wire:keydown.delete="reset_marca"
                ...
                <div class="col">
                    <input type="text" class="form-input " placeholder="Buscar Vitola" wire:model="vito"
                        style="width:100%;height:34px;" wire:keydown.escape="reset_vitola"
                ...
                <div class="col">
                    <input type="text" class="form-input " placeholder="Buscar Nombre" wire:model="nom"
                        style="width:100%;height:34px;" wire:keydown.escape="reset_nombre"
                ...
                <div class="col">
                    <input type="text" class="form-input " placeholder="Buscar Capa" wire:model="capa"
                        style="width:100%;height:34px;" wire:keydown.escape="reset_capa"
                ...
                <div class="col">
                    <input type="text" class="form-input " placeholder="Buscar Tipo Empaque" wire:model="empa"
                        style="width:100%;height:34px;" wire:keydown.escape="reset_empaque"
    ...
    <div style="  display: none;justify-content: center;align-items: center;height: 100%;position:fixed;top:0px;width:50%;left:25%;"
        ...
        <form action="{{Route('nuevo_pendiente')}} " method="POST">
            <div data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                aria-hidden="true" style="background:#212529;width=800px;">
                <div>
