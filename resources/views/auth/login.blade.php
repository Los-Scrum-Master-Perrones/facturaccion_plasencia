...
<body style="background: url('fondologin.jpg') center center no-repeat;    background-size:100% 100%;">
    <div style="  display: flex;justify-content: center;align-items: center;height: 100%;">
        <div
            style=" -webkit-background-size: cover;  -moz-background-size: cover;  background-repeat:no-repeat;  -o-background-size: cover;  background-size: cover;  width: 350px;height:350px; background-size: 100% 100%;">
            ...
            <form method="POST" action="{{ route('login') }}" class="go-right">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a type="checkbox" class="input-group-text"onclick="mostrarContrasena()"
                            style=" background: transparent;color:#fff;outline: none;border: none;cursor:pointer;width:auto">
