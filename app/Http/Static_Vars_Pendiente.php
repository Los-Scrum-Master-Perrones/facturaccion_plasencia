...
class Static_Vars_Pendiente{
   ...
   public static $cat4 = "";
    ...
    public static $presentacion2 = "";
    public static $presentacion3 = "";
    public static $item = "";
    public static $orden = "";
   ...
   // metodo get y set
    ...
    public static function getpresentacions() {
      ...
      // metodo get y set
    public static function Setpresentacions2($presentacion2) {
        self::$presentacion2 = $presentacion2;
     }

     public static function getpresentacions2() {
         return self::$presentacion2;
      }

       // metodo get y set
    public static function Setpresentacions3($presentacion3) {
        self::$presentacion3 = $presentacion3;
     }

     public static function getpresentacions3() {
         return self::$presentacion3;
      }
     // metodo get y set
