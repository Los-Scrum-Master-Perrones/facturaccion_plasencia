<html>
  ...
  <body style="background: #888; background-size:100% 100%;">
...
<form action=  "{{Route('principal')}}" method= "GET">
  @csrf
  <button type="submit"  class="buttonsubmit" style="margin-bottom: -10px;">  <span><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
...
<form action=  "{{Route('tabla')}}" method= "GET">
  ...
  <div class="text">IMPORTACION</div>
</div>
