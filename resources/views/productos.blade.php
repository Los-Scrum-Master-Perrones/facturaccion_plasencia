                    ...
                    <table id="editable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button style="font-size:12px;" data-toggle="modal"
                                        data-target="#modal_agregarproducto"
                                        onclick="agregar_item({{$producto->id_producto}},{{ strlen($producto->item)}})">Agregar
                                        detalle</button>
