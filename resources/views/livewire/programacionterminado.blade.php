                            ...
                            <tbody id="tablechange">
                                ...
                                @foreach($detalles_programaciones as $detalles_programacione)
                                    <tr>
                                        ...
                                        <td> {{ round($detalles_programacione->saldo/$detalles_programacione->cantidad_bultos, 2) }}</td>
                                        <td> {{ $detalles_programacione->saldo }}</td>
                                        <td>{{$detalles_programacione->listos}}</td>
                                        @if($detalles_programacione->saldo!=0)
                                        <td><b>{{$detalles_programacione->saldo - $detalles_programacione->listos}}</b></td>
                                        @else
                                        <td><b>N.A</b></td>
                                        @endif
                    ...
                    <div style=""  class="modal-body">
                        <div id="etiqueta" style="width:10.5cm; height:17cm;">
                            ...
                            <div class="offset-md-1 col-sm-8" style="text-align:center;">
                                <h1 contenteditable id="mark" style="font-family: fantasy;" class="">DECADE BY RP</h1>
                            </div>
                            </div>
                            ...
                            <div class="offset-md-2 col-sm-6" style="text-align:center;">
                                <h1 id="size" contenteditable style="font-family: fantasy;" class="">6-1/2 X 52</h1>
                            </div>
                            </div>
                            ...
                            <div class="offset-md-2 col-sm-6" style="text-align:center;">
                                <h1 id="shape" contenteditable style="font-family: fantasy;" class="">TORO PRESS</h1>
                            </div>
                            </div>
                            ...
                            <div class="offset-md-2 col-sm-6" style="text-align:center;">
                                <h1 id="wrapper" contenteditable style="font-family: fantasy;" class="">SUMATRA</h1>
                            </div>
                            </div>
                            ...
                            <div class="offset-md-2 col-sm-6" style="text-align:center;">
                                <h1 contenteditable style="font-family: fantasy;" id="quantity" class="">560</h1>
                            </div>
                            </div>
                            ...
                            <div class="offset-md-2 col-sm-6" style="text-align:center;">
                                <h1 id="date" contenteditable style="font-family: fantasy;" class="">MES-00-0000</h1>
                            </div>
                            </div>
                            ...
                            <div class="offset-md-2 col-sm-6" style="text-align:center;">
                                <h1 contenteditable id="box" style="font-family: fantasy;" class="">00</h1>
                            </div>
                            </div>
