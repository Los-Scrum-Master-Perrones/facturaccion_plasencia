<div xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <div class="input-group" style="width:40%; position: fixed;right: 0px;bottom:0px; height:30px;">
        ...
        <input type="text" class="form-control fs-7" id="sumap" value="{{ $moldes_exitentea }}">
        <span class="form-control input-group-text fs-7">Sin moldes</span>
        <input type="text" class="form-control fs-7" id="sumap" value="{{ $moldes_sin_molde }}">
        <span class="form-control input-group-text fs-7">Moldes Necesarios</span>
        <input type="text" class="form-control fs-7" id="sumap"
            value="{{ number_format($moldes_nesarios_base10, 0) }}">
