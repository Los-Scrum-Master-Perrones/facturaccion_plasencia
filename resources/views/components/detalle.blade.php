    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <form action=  "{{ Route('buscar') }}" method= "POST" class="form-inline" name="form_tabla"
                    id="form_tabla">
                    @csrf
                ...
                <button style="text-align: right;" data-bs-toggle="modal" data-bs-target="#modal_nuevoproducto">Nuevo
                    producto</button>
                        ...
                        <tbody>
                            @foreach ($productos as $producto)
                                <tr>
                                    ...
                                    <td><button style="font-size:12px;" data-bs-toggle="modal"
                                            data-bs-target="#modal_agregarproducto"
                                            onclick="agregar_item({{ $producto->item }},{{ strlen($producto->item) }})">Agregar
                                            detalle</button>
                                        <button style="font-size:12px;" data-bs-toggle="modal"
                                            onclick="item_detalle({{ $producto->item }},{{ strlen($producto->item) }})">Ver
                                            detalle</button>
                                    </td>
                                </tr>
                            @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                <label style="font-size:16px" for="txt_malos" class="form-label">Tipo de
                                    empaque</label>
                                <input name="tipo" id="tipo"style="font-size:16px" class="form-control"
                                    required type="text" autocomplete="off">
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col">
                            ...
                            <input type="checkbox" name="upc_de" id="upc_de"style="font-size:20px"
                                value="si">
                            <label style="font-size:16px" for="upc" class="form-label">UPC</label>
                        </div>
