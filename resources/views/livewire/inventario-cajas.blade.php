<div xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
            <a style="color:#E5B1E2; font-size:12px;" href="{{ route('inventario_cajas') }}"><strong>Existencia de cajas</strong></a>
        </li>
        <li class="nav-item">
    ...
    <div class="container" style="max-width:100%; ">
        ...
        <div class="row" style="text-align:center;">
            ...
            <div class="col-2">
                <div class="input-group mb-3">
                    <a href="index_importar_cajas"
                    class="btn btn-primary"
                    style="width:100px;height: 35;border-radius: 20%">Importar</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <thead>
                    <tr style="font-size:16px; text-align:center;">
                        ...
                        <th wire:ignore style=" text-align:center;">
                            <select name="todas_codigos" id="todas_codigos" onchange="buscar_io()">
                        ...
                        <th wire:ignore style=" text-align:center;">
                            <select name="todas_marca" id="todas_marca" onchange="buscar_io()">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#tabla_materiales').css('height', ($('#bos').height() - 230));
            var seletscc = ["todas_codigos", "todas_marca"];
