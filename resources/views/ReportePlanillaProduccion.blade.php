...
@foreach ($pendiente as $key => $pend)
    ...
    @if( $empleado == $pend->nombre_empleado)
        <tr>
            ...
            <td style="text-align: center">{{ number_format($pend->precio * $pend->suma_total,2) }}</td>
            <td></td>
        </tr>
        @php
                $lunes_e += $pend->lunes;
    ...
    @else
        ...
        <tr>
            ...
            <td style="text-align: center;color: red"><b>{{ number_format($e_suma_total_precio,2) }}</b></td>
            <td><b></b></td>
        </tr>
            @php
                    $lunes_e = 0;
...
<tr>
    ...
    <td style="color: red; font-size: 10px; font-family: Arial"><b>{{ number_format($e_suma_neto_precio,2) }}</b></td>
    <td></td>
</tr>
<tr></tr>
<tr>
    ...
    <td style="color: red; font-size: 10px; font-family: Arial;text-align: center"><b>{{ number_format($e_suma_neto_precio,2) }}</b></td>
</tr>
