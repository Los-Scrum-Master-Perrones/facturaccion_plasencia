                <table class="table table-light" id="editable">
                    <tr>
                        ...
                        <th style="text-align:center; font-family: Tahoma;font-size:24px;" colspan="3" ><b>CARIBBEAN CIGARS COMPANY</b></th>
                    ...
                    <tr>
                        <th></th><th></th><th></th><th></th><th></th><th></th><th></th>
                        <th style="font-family: Tahoma; font-size: 8"><b>E-Mail:                                      taosasanmarcos@plasenciatabaco.com</b></th>
                    </tr>
                    <tr>
                        <th></th><th></th><th></th><th></th><th></th><th></th><th></th>
                    ...
                    <tr>
                        ...
                        <th style="font-family: Tahoma; font-size: 10" colspan="5"><b>ROCKY PATEL PREMIUM CIGARS, INC.</b></th>
                    </tr>
                    <tr>
                        <td style="font-family: Tahoma; font-size: 8"><b>Sold to</b></td>
                        <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                        <td style="font-family: Tahoma; font-size: 8"><b>11 de MAYO del 2018</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td style="font-family: Tahoma; font-size: 10;text-align: center"><b>Consigned to</b></td>
                        <td></td><td></td>
                    ...
                    <tbody>
                        ...
                        <tr style="font-size:10px;">
                            ...
                            <td style="text-align:center;font-size:9px; height: 24px;border: 5px solid #C00;overflow-x:auto;overflow-x:auto;"><b>{{$detalles->cantidad_cajas}}</b></td>
                            ...
                            <td style="text-align:center;font-size:9px; height: 24px;border: 5px solid #C00;overflow-x:auto;overflow-x:auto;">{{$detalles->cantidad_por_caja}}</td>
                        ...
                        <tr style="font-size:10px;">
                            ...
                            <td style="text-align:center;font-size:9px; height: 24px;border: 5px solid #C00;overflow-x:auto;"></td>
                            <td style="text-align:center;font-size:9px; height: 24px;border: 5px solid #C00;overflow-x:auto;"><b></b></td>
        ...
        ?>
                            ...
                            <td style="text-align:center;font-size:9px; height: 24px;border: 5px solid #C00;"><b>{{$detalles->cantidad_cajas}}</b></td>
                            ...
                            <td style="text-align:center;font-size:9px; height: 24px;border: 5px solid #C00;">{{$detalles->cantidad_por_caja}}</td>
