...
! function (t) {
    ...
    t.fn.Tabledit = function (e) {
        ...
        return r.columns.identifier(), r.columns.editable(), r.columns.toolbar(), d.onDraw(),  (i.on("click", "button.tabledit-delete-button", function (e) {
            if (e.handled !== !0) {
                e.preventDefault();
