    ...
    <div class="container" style="max-width:100%; ">
            ...
            <div class="col">
                <div class="input-group mb-3">
                    ...
                    <form wire:submit.prevent="importar_excel" hidden>
                        <div class="col-sm">
                            <input type="file" wire:model="select_file" id="select_file" class="btn  form-control" style="width:350px;" />
                        </div>
                        <div class="col-sm">
                            <button type="submit" name="upload" style="width:130px;" class="btn botonprincipal form-control" value="Importar">
                        </div>
                    </form>
                        ...
                        <table class="table table-light  table-hover" id="editable" style="font-size:10px;m">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$tipo->por_caja}}</td>
                                    <td> <a style=" width:10px; height:10px;" onclick="edaditar('{{$tipo->id_tipo_empaque}}','{{$tipo->tipo_empaque}}','{{$tipo->tipo_empaque_ingles}}',{{$tipo->por_caja == null? 0 :$tipo->por_caja}})" href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                            </svg>
     ...
     height:500px;">
        ...
        <form action="{{Route('insertar_marca')}}" method='POST' id="formmarca" name="formmarca">
            <div class="modal fade" id="modal_marca" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="marcam" type="text" name="marcam" required placeholder="Agregar marca" style="width: 440px" autocomplete="off">
                            </div>
                        </div>
        ...
        <form action="{{Route('editar_marca')}}" method='POST' id="formmarcaE" name="formmarcaE">
            @csrf
            <div class="modal fade" id="modal_marcaE" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="marcae" type="text" name="marcae" required placeholder="Editar marca" style="width: 440px" autocomplete="off" value="{{$editar_nombre_marca}}">
        ...
        <form action="{{Route('insertar_capa')}}" method='POST' id="formcapa" name="formcapa">
            <div class="modal fade" id="modal_capa" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="capam" type="text" name="capam" placeholder="Agregar marca" required style="width: 440px" maxLength="30" autocomplete="off">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">
        ...
        <form action="{{Route('editar_capa')}}" method='POST' id="formcapaE" name="formcapaE">
            <div class="modal fade" id="modal_capaE" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="capamE" type="text" name="capamE" placeholder="Editar capa" required style="width: 440px" maxLength="30" autocomplete="off" value="{{$editar_nombre_capa}}">
        ...
        <form action="{{Route('insertar_nombre')}}" method='POST' id="formnombre" name="formnombre">
            <div class="modal fade" id="modal_nombre" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="nombrem" type="text" name="nombrem" required placeholder="Agregar marca" style="width: 440px" maxLength="100" autocomplete="off">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">
        ...
        <form action="{{Route('editar_nombre')}}" method='POST' id="formnombre_editar" name="formnombre_editar">
            <div class="modal fade" id="modal_nombreE" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="nombremE" type="text" name="nombremE" required placeholder="Editar nombre" style="width: 440px" maxLength="100" autocomplete="off" value="{{$editar_nombre_nombre}}">
        ...
        <form action="{{Route('insertar_tipo')}}" method='POST' id="formtipo" name="formtipo">
            <div class="modal fade" id="modal_tipo" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="tipom" type="text" name="tipom" required placeholder="Agregar tipo de empaque (Cajas 1/20)" style="width: 440px" maxLength="100" autocomplete="off">
                            </div>
                            <div class="mb-3 col">
                                <label for="txt_vitola" class="form-label">Nombre Ingles</label>
                                <input class="form-control" id="ingles_tipom" type="text" name="ingles_tipom" required placeholder="BOX 20" style="width: 440px" maxLength="100" autocomplete="off">
                            </div>
                            <div class="mb-3 col">
                                <label for="txt_vitola" class="form-label">Cantidad</label>
                                <input class="form-control" id="cantidadm" type="text" name="cantidadm" required placeholder="10" style="width: 440px" maxLength="100" autocomplete="off">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">
        ...
        <form action="{{Route('insertar_vitola')}}" method='POST' id="formvitola" name="formvitola">
            <div class="modal fade" id="modal_vitola" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="vitolam" type="text" name="vitolam" required placeholder="Agregar nueva vitola" style="width: 440px" maxLength="30" autocomplete="off">
        ...
        <form action="{{Route('editar_vitola')}}" method='POST' id="formvitolaE" name="formvitolaE">
            <div class="modal fade" id="modal_vitolaE" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" id="vitolamE" type="text" name="vitolamE" required placeholder="Editar vitola" style="width: 440px" maxLength="30" autocomplete="off" value="{{$editar_nombre_vitola}}">
        ...
        <script>
            ...
            async function edaditar(id, tipo, ingles_tipo, cantidad) {
                var html = '<div>' +
                    '<div>' +
                    '<div>' +
                    '<div><br>' +
                    ...
                    'placeholder="Editar tipo de empaque" style="width: 360px" maxLength="100"  autocomplete="off" value="' + tipo + '" >' +
                    '</div>' +
                    '<div class="mb-3 col">' +
                    ...
                    'placeholder="BOX 20" style="width: 360px" maxLength="100" autocomplete="off" value="' + ingles_tipo + '">' +
                    '</div>' +
                    '<div class="mb-3 col">' +
                    '<label for="txt_empaque" class="form-label">Cantidad</label>' +
                    '<input class="form-control" id="cantidadmE" type="number" name="cantidadmE" required' +
                    ' placeholder="10" style="width: 360px" maxLength="100" autocomplete="off" value="' + cantidad + '">' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                ...
                const {
                    ...
                    , preConfirm: () => {
                        return [
                            id
                            , document.getElementById('tipomE').value
                            , document.getElementById('ingles_tipomE').value
                            , document.getElementById('cantidadmE').value
                        ]
                    }
                ...
                if (formValues) {
                    if ( formValues[1] == "" ) {
                        toastr.info('Debe escribir el tipo de empaque.', 'Advertencia!');
                    } else if ( formValues[2] == "") {
                        toastr.info('Tipo de empaque en ingles necesario para la factura.', 'Advertencia!');
                    } else if ( formValues[3] == "") {
                        toastr.info('Ingrese la cantidad de puros por empaque.', 'Advertencia!');
                    } else {
                        @this.editar_tipo({
                            'id': formValues[0]
                            , 'tipomE': formValues[1]
                            , 'ingles_tipomE': formValues[2]
                            , 'cantidadmE': formValues[3]
                        });
                    }
                }
            }
