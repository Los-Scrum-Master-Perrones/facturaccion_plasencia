<div xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <ul class="nav nav-tabs justify-content-center">
        ...
        @else
            <li class="nav-item">
                <a class="nav-link" style="color:white; font-size:12px;" href="import_excel"><strong>Importar
                        pedido</strong></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="color:#E5B1E2; font-size:12px;"
                    href="pendiente_salida"><strong>Reporte</strong></a>
            </li>
        @endif
    </ul>
    ...
    <div class="container" style="max-width:100%; ">
        <div class="row">
            ...
            <div class="col-sm-2">
                <input type="date" name="fech1a" id="fech1a" class="form-control" placeholder="Nombre"
                    wire:model="fecha_1">
            </div>
            <div class="col-sm-2">
                <input type="date" name="fech2a" id="fech2a" class="form-control" placeholder="Nombre"
                    wire:model="fecha_2">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2" wire:ignore>
                <input name="nombre" id="nombre" class="form-control form-control-sm" style="height: 35px;" placeholder="Numero Factura"
                    wire:model="num_fac">
            </div>

            <div class="col-sm-2">
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle form-control  form-control-sm"  style="height: 35px;" type="button"
            ...
            <div class="col-sm-2">
                <button wire:click="exportar_reporte()" class="botonprincipal"  style="height: 35px;">Exportar</button>
            </div>
        </div>
        ...
        <div class="row">
            <div class="panel-body">
                <div style="width:100%; font-size:10px; overflow-x: display; overflow-y: auto; height:75vh;">
                    @csrf
                            ...
                            @foreach ($productos as $producto)
                                <tr>
                                    ...
                                    <td style="text-align: end">
                                        {{ number_format($producto->total_precio_tabacos, 2) }}
                                    </td>
        ...
        <div class="input-group" style="width:45%;position: fixed;right: 0px;bottom:0px; height:30px;display:flex;"
            ...
            <input type="number" class="form-control  mr-sm-4" placeholder="0" value="{{ $total_cajas_tabla }}"
                readonly>
            ...
            <input type="number" class="form-control  mr-sm-4" placeholder="0" value="{{ $total_puros_dinero }}"
                readonly>
        </div>
    </div>
