        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <form action="{{Route('buscar_pendiente')}}" method="POST" class="form-inline"
                    ...
                    @csrf
                    <label>De</label>
                    <input type="date" name="fecha_de" id="fecha_de" class="form-control mr-sm-2" placeholder="Nombre"
                        style="width:150px;">
                    <label>Hasta</label>
                    <input type="date" name="fecha_hasta" id="fecha_hasta" class="form-control mr-sm-2"
                        placeholder="Nombre" style="width:150px;">
                    <input name="nombre" id="nombre" class="form-control mr-sm-2" placeholder="Nombre"
                        style="width:150px;">
