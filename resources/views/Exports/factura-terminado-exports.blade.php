                <table class="table table-light" id="editable">
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th></th>
                        <th style="font-family: Tahoma; font-size: 8"><b>E-Mail: taosasanmarcos@plasenciatabaco.com</b>
                        </th>
                    </tr>
                    <tr>
                        <th></th>
                    ...
                    <tr>
                        ...
                        <th style="font-family: Tahoma; font-size: 10" colspan="5"><strong>Rocky Patel Premium Cigar
                                INC</strong></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th style="font-family: Tahoma; font-size: 10" colspan="5"><strong>4244 CORPORATE
                                SQUARE</strong></th>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <th style="font-family: Tahoma; font-size: 10" colspan="5"><strong>NAPLES, FL 34104,
                                USA</strong></th>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <th style="font-family: Tahoma; font-size: 10" colspan="6"><strong>'Shawn Bussler'
                                sbussler@rockypatel.com</strong></th>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <th style="font-family: Tahoma; font-size: 10" colspan="5"><strong>PHONE: 239 593
                                1833</strong></th>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <th style="font-family: Tahoma; font-size: 10" colspan="5"><strong>FAX: 239 593 1839</strong>
                        </th>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <th style="font-family: Tahoma; font-size: 10" colspan="5"><strong>Tax ID: 56
                                1948219</strong></th>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td style="font-family: Tahoma; font-size: 10" colspan="3"><b>TEL: 305 345-5809 / 305
                                323-5713</b></td>
                    </tr>
                    <tr></tr>
                    <tr>
                        <th style="font-family: Tahoma; font-size: 10; text-align: center"><strong><i>Seals</i></strong>
                        </th>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tbody>
                        ...
                        ?',
                            ...
                            ?',
                                    ...
                                    <td
                                        style="text-align:right;font-size:9px; height: 24px;border: 5px solid #C00;overflow-x:auto;overflow-x:auto;"></td>
                    ...
                    <tr>
                        <td style="font-family: Thaoma;font-weight: bold; font-size: 10" colspan="14">
                            “*These cigars (1) are wrapped in whole tobacco leaf; (2) contain a 100 percent leaf tobacco
                            binder; (3) contain at least 50 percent (of the filter by weight) long filler tobacco; (4)
                            are
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family: Thaoma;font-weight: bold; font-size: 10" colspan="14">
                            handmade or hand rolled; (5) have no filter, nontobacco tip, or nontobacco mouthpiece; (6)
                            do not have a characterizing flavor other than tobacco; (7) contain only tobacco, water, and
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family: Thaoma;font-weight: bold; font-size: 10" colspan="14">
                            vegetable gum with no other ingredients or additives; and (8) weigh more than 6 pounds per
                            1,000 units.”
                        </td>
                    </tr>
                    <tr>
