...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#navMenu").click(function () {
    //$(".nav").toggleClass("small");
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nav").hasClass("small")) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nav").removeClass("small");
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nav").addClass("small");
    }
  });
});
