                        ...
                        <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                            ...
                            <div class="form-check ">
                                <input class="form-check-input form-control" type="checkbox" value="3"
                                    wire:model="r_tres" id="checkbox3">
                            ...
                            <div class="form-check ">
                                <input class="form-check-input form-control" type="checkbox" value="4"
                                    wire:model="r_cuatro" id="checkbox4">
        ...
        function datos_modal_actualizar(id, item) {
            ...
            for (var i = 0; i < datasss.length; i++) {
                if (datasss[i].id_pendiente === id) {
                    ...
                    producto =
                        document.getElementById("titulo").innerHTML = "".concat(datasss[i].marca, " ", datasss[i]
                            .nombre,
                            " ",
