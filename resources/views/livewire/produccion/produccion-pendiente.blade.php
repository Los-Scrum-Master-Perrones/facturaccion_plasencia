<div xmlns:wire="http://www.w3.org/1999/xhtml">
    <div class="container" style="max-width:100%;">
        ...
        <div class="row" wire:ignore style="margin-bottom:2px">
                ...
                <div class="row">
                    <div class="col">
                        <div class="btn-group" style="height: 35px;" role="group" aria-label="Basic mixed styles example">
                            @if (auth()->user()->rol == -1)
                            @else
                            <button class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#productos_crear"  wire:click='nuevo_pendiente()'>
            ...
            <div class="col">
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle form-control" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown">
                        Presentacion
                    </button>
                    <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                        <div class="form-check ">
                            <input class="form-check-input" type="checkbox" value="Puros Tripa Larga" id="checkbox5" checked name="checkbox5" wire:model="tipo1">
                            <label class="form-check-label " for="flexCheckDefault"> Puros Tripa Larga </label>
                        </div>

                        <div class="form-check ">
                            <input class="form-check-input" type="checkbox" value="Puros Tripa Corta" id="checkbox6" checked name="checkbox6" wire:model="tipo2">
                            <label class="form-check-label " for="flexCheckChecked"> Puros Tripa Corta </label>
                        </div>

                        <div class="form-check ">
                            <input class="form-check-input " type="checkbox" value="Puros Sandwich" id="checkbox7" checked name="checkbox7" wire:model="tipo3">
                            <label class="form-check-label " for="flexCheckDefault"> Puros Sandwich </label>
                        </div>
                        <div class="form-check ">
                            <input class="form-check-input " type="checkbox" value="Puros Brocha" id="checkbox7" checked name="checkbox7" wire:model="tipo4">
            ...
            <div class="col" wire:ignore>
                <select onchange="buscar_tabla()" name="b_orden" id="b_orden" style="width:100%;height:34px;" name="states[]">
            ...
            <div class="col" wire:ignore>
                <select onchange="buscar_tabla()" name="b_mes" id="b_mes" style="width:100%;height:34px;" name="states[]">
            ...
            <div class="col" wire:ignore>
                <select onchange="buscar_tabla()" name="b_fecha" id="b_fecha" style="width:100%;height:34px;" name="states[]">
        ...
        <div class="row" wire:ignore>
            <div class="col" wire:ignore>
                <select onchange="buscar_tabla()" name="b_marca" id="b_marca" style="width:100%;height:34px;" name="states[]">
            ...
            <div class="col" wire:ignore>
                <select onchange="buscar_tabla()" name="b_nombre" id="b_nombre" style="width:100%;height:34px;" name="states[]">
            ...
            <div class="col" wire:ignore>
                <select onchange="buscar_tabla()" name="b_vitola" id="b_vitola" style="width:100%;height:34px;" name="states[]">
            ...
            <div class="col" wire:ignore>
                <select onchange="buscar_tabla()" name="b_capa" id="b_capa" style="width:100%;height:34px;" name="states[]">
    ...
    @if (auth()->user()->rol == -1)
    @else
    <div wire:ignore class="modal fade" id="productos_crear" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="productos_crear" aria-hidden="true" style="opacity:.9;background:#212529;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <select name="itemn" id="itemn" style="height:30px; width: 100%;" class="fs-7" required type="text" autocomplete="off" onchange="buscar_codigo()">
                            ...
                            <div class="mb-3 col">
                                ...
                                <input class="form-control fs-7" name="presentacionn" id="presentacionn" wire:model='presentacionn' placeholder="Ingresa figura y tipo" style="overflow-y: scroll; height:30px;" disabled>
                            </div>

                            <div class="mb-6 col">
                                <label for="txt_vitola" class="form-label">Marca</label>
                                <input class="form-control fs-7" style=" height:30px; width: 100%;" name="marcan" id="marcan" wire:model='marcas_nuevo' placeholder="Ingresa figura y tipo" disabled>
                        ...
                        <div class="row">
                            <div class="mb-4 col">
                                ...
                                <input class="form-control fs-7" style=" height:30px; width: 100%;" name="capan" id="capan" wire:model='capas_nuevo' placeholder="Ingresa figura y tipo" disabled>
                            </div>

                            <div class="mb-4 col">
                                <label for="vitola" class="form-label">Vitola</label>
                                <input class="form-control fs-7" style=" height:30px; width: 100%;" name="vitolan" wire:model='vitolas_nuevo' id="vitolan" placeholder="Ingresa figura y tipo" disabled>
                            </div>

                            <div class="mb-4 col">
                                <label for="txt_total" class="form-label">Nombre</label>
                                <input class="form-control fs-7" style=" height:30px; width: 100%;" name="nombren" wire:model='nombres_nuevo' id="nombren" placeholder="Ingresa figura y tipo" disabled>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                ...
                                <input name="ordensis" id="ordensis" style="font-size:16px" class="form-control fs-7" type="text" autocomplete="off" wire:model.defer='produc_pendiente.orden_sistema'>
                            </div>

                            <div class="mb-3 col">
                                <label for="txt_figuraytipo" class="form-label">Fecha</label>
                                <input value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" name=" fechan" id="fechan" style="font-size:12px" class="form-control fs-7" required type="date" autocomplete="off" wire:model.defer='produc_pendiente.fecha_recibido'>
                            </div>

                            <div class="mb-6 col">
                                <label for="txt_figuraytipo" class="form-label">Observacion</label>
                                <input name="observacionn" id="observacionn" style="font-size:16px" class="form-control fs-7" type="text" autocomplete="off" wire:model.defer='observacion'>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                ...
                                <input name="paquetes" id="paquetes" class="form-control fs-7" required type="number" autocomplete="off" wire:model.defer='produc_pendiente.cantidad'>
                            </div>
                            <div class="mb-3 col">
                            </div>
                            <div class="mb-3 col">
    ...
    <div class="panel-body">
        <div style="width:100%; padding-left:0px;  font-size:9px;   overflow-x: display; overflow-y: auto; height:75%;">
                ...
                <tbody name="body" id="body">
                    ...
                    <tr>
                        ...
                        <td style="width:120px; text-align: center">
                            ...
                            <a style="text-decoration: none" onclick="enviar_produccion({{ $detalle->id }})" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-send-arrow-down-fill" viewBox="0 0 16 16">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" style="opacity:.9;background:#212529;width=80%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button id='boton_cerrar_modal_actualizar' type="button" class="btn-close" data-bs-dismiss="modal"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col">
                            <label for="txt_figuraytipo" class="form-label">Orden del sistema</label>
                            <input name="orden_sistema2" id="orden_sistema2" class="form-control" type="text" wire:model.defer='produc_pendiente.orden_sistema'
                                autocomplete="off">
                        </div>
                        <div class="mb-3 col">
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col">
                            ...
                            <input name="pendiente2" id="pendiente2" class="form-control" type="text" wire:model.defer='produc_pendiente.cantidad'
                                autocomplete="off">
                        </div>
                        <div class="mb-3 col">
...
<script type="text/javascript">
    ...
    function selects(nombre) {
        new TomSelect(nombre, {
            create: '#itemn'=== nombre ? true : false
            , sortField: {
                field: "text"
                , direction: "asc"
            }
