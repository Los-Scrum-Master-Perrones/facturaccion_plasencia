<div xmlns:wire="http://www.w3.org/1999/xhtml">
            ...
            <div class="col">
                <div class="input-group mb-3">
                    ...
                    <div wire:loading.attr="hidden">
                        <a type="button" name="crear_programacion" id="crear_programacion" wire:click.prevent="cambio(1)" class=" botonprincipal   mr-sm-2" value="" style="width:70px; " href="">
                    ...
                    @if(auth()->user()->rol == 0 || auth()->user()->rol == 1)
                    <button type=" button" onclick="guardar_programacion()" class=" botonprincipal " style="width:auto;"> Crear programación
                    </button>
                    @endif
                ...
                <table class="table table-light" id="editable" style="font-size:10px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if (intval($detalle_provicional->cantidad_sobrante_puros) < 0) <td style="color: red">{{'Faltan '.intval($detalle_provicional->cantidad_sobrante_puros)}}</td>
                                @endif
                                ...
                                @if (intval($detalle_provicional->cantida_sobrante) < 0) <td style="color: red">{{'Faltan '.intval($detalle_provicional->cantida_sobrante)}}</td>
                                    @endif
                                    ...
                                    <td style="text-align:center">
                                        ...
                                        <a onclick="eliminar_detalle_prgramacion({{$detalle_provicional->id}})" href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" clcass="bi bi-trash-fill" viewBox="0 0 16 16">
                                                <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z" />
                                            </svg>
                                        </a>

                                        <a style=" width:10px; height:10px;" href="#" onclick="editar_saldo({{$detalle_provicional->id}})">
                        ...
                        <tr>
                            ...
                            @if ($materiale->restante < 0) <td style="color: red">{{'Faltan '.$materiale->restante }}</td>
                                @endif
    ...
    <div @if($ventanas==2) hidden @endif>
        <div class="container" style="max-width:100%; ">
            <div class="row" style="margin-bottom:2px">
                ...
                <div class="col">
                    <div class="row">
                        <div class="btn-group" style="height: 35px;" role="group" aria-label="Basic mixed styles example">
                            @if(auth()->user()->rol == 0 || auth()->user()->rol == 1)
                                <button class="btn btn-dark"  onclick="agregar_a_programacion()">
                            ...
                            @endif
                            <button wire:loading.attr.remove='hidden' id="btn_guardar" class="btn btn-danger" hidden disabled>
                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            </button>
                            <a class="btn btn-danger" wire:loading.attr="hidden" href="#" wire:click.prevent="cambio(2)"><abbr title="Revisar Programacion actual">Ver</abbr></a>
                        ...
                        <form hidden  id="form_actualizar_datos" action="{{ route('materiales_empaque.actualizar_datos') }}" method="POST">
                            @csrf
                            ...
                            <input type="text" hidden name="busqueda_marcas_p" id="busqueda_marcas_p" wire:model='busqueda_marcas_p'>
                            <input type="text" hidden name="busqueda_nombre_p" id="busqueda_nombre_p" wire:model='busqueda_nombre_p'>
                            <input type="text" hidden name="busqueda_vitolas_p" id="busqueda_vitolas_p" wire:model='busqueda_vitolas_p'>
                            <input type="text" hidden name="busqueda_capas_p" id="busqueda_capas_p" wire:model='busqueda_capas_p'>
                            <input type="text" hidden name="busqueda_empaques_p" id="busqueda_empaques_p" wire:model='busqueda_empaques_p'>
                            <input type="text" hidden name="busqueda_items_p" id="busqueda_items_p" wire:model='busqueda_items_p'>
                            <input type="text" hidden name="busqueda_ordenes_p" id="busqueda_ordenes_p" wire:model='busqueda_ordenes_p'>
                            <input type="text" hidden name="busqueda_hons_p" id="busqueda_hons_p" wire:model='busqueda_hons_p'>
                            <input type="text" hidden name="r_mill" id="r_mill" wire:model='r_mill'>
                        </form>

                        <form  hidden id="form_exportar_pendiente" action="{{ route('materiales_empaque.exporPendiente') }}" method="POST">
                            @csrf
                            <input type="text" hidden name="r_uno" id="r_uno" wire:model='r_uno'>
                            <input type="text" hidden name="r_dos" id="r_dos" wire:model='r_dos'>
                            <input type="text" hidden name="r_tres" id="r_tres" wire:model='r_tres'>
                        ...
                        <form hidden id="form_exportar_materiales" action="{{ route('materiales_empaque.exportMateriales') }}" method="POST">
                            @csrf
                            <input type="text" hidden name="busqueda_items_p" id="busqueda_items_p" wire:model='busqueda_items_p'>
                            <input type="text" hidden name="busqueda_hons_p" id="busqueda_hons_p" wire:model='busqueda_hons_p'>
                            <input type="text" hidden name="busqueda_ordenes_p" id="busqueda_ordenes_p" wire:model='busqueda_ordenes_p'>
                            <input type="text" hidden name="busqueda_mes_p" id="busqueda_mes_p" wire:model='busqueda_mes_p'>
                        </form>
                    </div>
                </div>
                <br>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                            <div class="form-check ">
                                <input class="form-check-input form-control" type="checkbox" value="1" wire:model="r_uno" id="checkbox1E" name="checkbox1E" checked>
                                <label class="form-check-label " for="flexCheckDefault"> NEW ROLL </label>
                            </div>

                            <div class="form-check ">
                                <input class="form-check-input form-control" type="checkbox" value="2" wire:model="r_dos" id="checkbox2E" name="checkbox2E" checked>
                                <label class="form-check-label " for="flexCheckChecked"> CATALOGO </label>
                            </div>

                            <div class="form-check ">
                                <input class="form-check-input form-control" type="checkbox" value="3" wire:model="r_tres" id="checkbox3E" name="checkbox3E" checked>
                                <label class="form-check-label " for="flexCheckDefault"> INVENTARIO EXISTENTE
                                </label>
                            </div>

                            <div class="form-check ">
                                <input class="form-check-input form-control" type="checkbox" value="4" wire:model="r_cuatro" id="checkbox4E" name="checkbox4E" checked>
                ...
                <div class="col">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                            <div class="form-check ">
                                <input class="form-check-input" type="checkbox" value="Puros Tripa Larga" id="checkbox5" checked name="checkbox5" wire:model="r_cinco">
                                <label class="form-check-label " for="flexCheckDefault"> Puros Tripa Larga </label>
                            </div>

                            <div class="form-check ">
                                <input class="form-check-input" type="checkbox" value="Puros Tripa Corta" id="checkbox6" checked name="checkbox6" wire:model="r_seis">
                                <label class="form-check-label " for="flexCheckChecked"> Puros Tripa Corta </label>
                            </div>

                            <div class="form-check ">
                                <input class="form-check-input " type="checkbox" value="Puros Sandwich" id="checkbox7" checked name="checkbox7" wire:model="r_siete">
                                <label class="form-check-label " for="flexCheckDefault"> Puros Sandwich
                                </label>
                            </div>

                            <div class="form-check ">
                                <input class="form-check-input " type="checkbox" value="Puros Brocha" id="checkbox7" checked name="checkbox7" wire:model="r_mill">
                ...
                <div class="col" wire:ignore>
                    <select onchange="buscar_tabla()" name="b_orden" id="b_orden" class=" mi-selector form-control" style="width:100%;height:34px;" name="states[]">
                ...
                <div class="col" wire:ignore>
                    <select onchange="buscar_tabla()" name="b_hon" id="b_hon" class=" mi-selector form-control" style="width:100%;height:34px;" name="states[]">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <abbr title="Exportar a excel">
                                <button class=" botonprincipal" wire:click="exportPendiente()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-spreadsheet" viewBox="0 0 16 16">
                ...
                <div class="col" wire:ignore>
                    <select onchange="buscar_tabla()" name="b_marca" id="b_marca" class=" mi-selector form-control" style="width:100%;height:34px;" name="states[]">
                ...
                <div class="col" wire:ignore>
                    <select onchange="buscar_tabla()" name="b_vitola" id="b_vitola" class=" mi-selector form-control" style="width:100%;height:34px;" name="states[]">
                ...
                <div class="col" wire:ignore>
                    <select onchange="buscar_tabla()" name="b_nombre" id="b_nombre" class=" mi-selector form-control" style="width:100%;height:34px;" name="states[]">
                ...
                <div class="col" wire:ignore>
                    <select onchange="buscar_tabla()" name="b_capa" id="b_capa" class=" mi-selector form-control" style="width:100%;height:34px;" name="states[]">
                ...
                <div class="col" wire:ignore>
                    <select onchange="buscar_tabla()" name="b_empaque" id="b_empaque" class=" mi-selector form-control" style="width:100%;height:34px;" name="states[]">
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item">
                                ...
                                <button type="button" class="page-link" style="height: 28px" wire:click='actualizar_fichas_pendiente_empaque()'>Actualizar</button>
    ...
    <div wire:ignore class="modal fade" id="productos_crear_empaque" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="productos_crear_empaqueLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <select name="itemn" id="itemn" style="height:30px; width: 100%;" class="form-control itema_nuevo" required type="text" autocomplete="off">
                            ...
                            <div class="mb-3 col">
                                ...
                                <select class="form-control" name="categoria" id="categoria" style="overflow-y: scroll; height:30px;" required>
                            ...
                            <div class="mb-3 col">
                                ...
                                <input class="form-control" name="presentacionn" id="presentacionn" wire:model='presentacion' placeholder="Ingresa figura y tipo" style="overflow-y: scroll; height:30px;" disabled>
                            </div>

                            <div class="mb-3 col">
                                <label for="txt_vitola" class="form-label">Marca</label>
                                <input style=" height:30px; width: 100%;" name="marcan" id="marcan" wire:model='marcas_nuevo' placeholder="Ingresa figura y tipo" disabled>
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input style=" height:30px; width: 100%;" name="capan" id="capan" wire:model='capas_nuevo' placeholder="Ingresa figura y tipo" disabled>
                            </div>
                            ...
                            <div class="mb-3 col">
                                <label for="txt_malos" class="form-label">Tipo de
                                    empaque</label>
                                <input style=" height:30px; width: 100%;" name="tipon" id="tipon" wire:model='tipo_empaques_nuevo' placeholder="Ingresa figura y tipo" disabled>
                            </div>


                            <div class="mb-3 col">
                                <label for="vitola" class="form-label">Vitola</label>
                                <input style=" height:30px; width: 100%;" name="vitolan" wire:model='vitolas_nuevo' id="vitolan" placeholder="Ingresa figura y tipo" disabled>
                            </div>

                            <div class="mb-3 col">
                                <label for="txt_total" class="form-label">Nombre</label>
                                <input style=" height:30px; width: 100%;" name="nombren" wire:model='nombres_nuevo' id="nombren" placeholder="Ingresa figura y tipo" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col">
                                ...
                                <input name="ordensis" id="ordensis" style="font-size:16px" class="form-control" type="text" autocomplete="off">
                            </div>

                            <div class="mb-2 col">
                                <label for="txt_figuraytipo" class="form-label">Orden</label>
                                <input name="ordenn" id="ordenn" style="font-size:16px" class="form-control" required type="text" autocomplete="off">
                            </div>


                            <div class="mb-2 col">
                                <label for="txt_figuraytipo" class="form-label">Fecha</label>
                                <input value="{{Carbon\Carbon::now()->format('Y-m-d')}}" name=" fechan" id="fechan" style="font-size:12px" class="form-control" required type="date" autocomplete="off">
                            </div>

                            <div class="mb-2 col">
                                <label for="txt_total" class="form-label">Pendiente</label>
                                <input name="pendienten" id="pendienten" class="form-control" required type="number" autocomplete="off">
                            </div>

                            <div class="mb-2 col">
                                <label for="txt_buenos" class="form-label">Saldo</label>
                                <input name="saldon" id="saldon" class="form-control" required type="number" autocomplete="off">
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-6 col">
                                ...
                                <input name="observacionn" id="observacionn" style="font-size:16px" class="form-control" type="text" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" role="dialog" id="modal_actualizar" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;width=800px;">
        <div class="modal-dialog modal-dialog-centered modal-lg" style="opacity:.9;background:#212529;width=80%">
            <div class="modal-content">

                <div class="modal-header">
                    <h5 id="staticBackdropLabel"><strong>Descripción del producto: </strong><span id="tituloupdate" name="tituloupdate"></span></h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col">
                            <label for="txt_figuraytipo" class="form-label">Orden del sistema</label>
                            <input name="orden_sistema2" id="orden_sistema2" class="form-control" type="text" autocomplete="off">
                        </div>
                        <div class="mb-3 col">
                            <label for="txt_figuraytipo" class="form-label">Orden</label>
                    ...
                    <div class="row">
                        <div class="mb-3 col">
                            ...
                            <input name="pendiente2" id="pendiente2" class="form-control" type="text" autocomplete="off">
                        </div>
                        <div class="mb-3 col">
                    ...
                    <div class="row">
                        <div class="mb-3 col">
                            ...
                            <input name="observacion2" id="observacion2" class="form-control" type="text" autocomplete="off">
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="modal_eliminar_tabla_progra" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="opacity:.9;background:#212529;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
