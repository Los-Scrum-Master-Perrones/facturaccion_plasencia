...
-- Volcando datos para la tabla facturacion_plasencia.item_faltantes: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla facturacion_plasencia.pedidos: 287 rows
DELETE FROM `pedidos`;
