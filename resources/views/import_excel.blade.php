...
<form method="post" enctype="multipart/form-data" action="{{ url('/importar_pendiente_empaque') }}" class="form-inline">
                    @csrf
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a style="color:white; font-size:12px;" href="historial_ventas"><strong>Reporte</strong></a>
        </li>
    </ul>
