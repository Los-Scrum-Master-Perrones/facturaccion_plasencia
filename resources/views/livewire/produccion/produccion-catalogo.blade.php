<div>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input name="ordensis" id="ordensis" style="font-size:16px" class="form-control fs-7"
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click="registra_producto()" class="btn btn-success"> <span>Guardar</span>
                    </button>
                </div>
            </div>
    ...
    <script>
        const Toast = Swal.mixin({
            ...
            var seletscc = ["#b_presentacion", "#b_codigo","#b_marca", "#b_nombre", "#b_vitola", "#b_capa","#marca_n","#nombre_n","#vitola_n","#capa_n"];
